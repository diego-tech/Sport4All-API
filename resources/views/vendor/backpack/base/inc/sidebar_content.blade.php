...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('club') }}'><i class='nav-icon la la-question'></i> Mi Club</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('court') }}'><i class='nav-icon la la-question'></i> Pistas</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('matchs') }}'><i class='nav-icon la la-question'></i> Partidos</a></li>
