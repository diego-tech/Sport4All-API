...
return [
    ...
    */
    ...
    'project_name' => 'Sports4All Admin Panel',
    ...
    */
    ...
    //'user_model_fqn' => config('auth.providers.clubs.model'),
    // 'user_model_fqn' => App\User::class, // works on Laravel <= 7
     'user_model_fqn' => App\Models\Club::class, // works on Laravel >= 8
